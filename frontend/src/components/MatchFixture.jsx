    ...
    return (
        <div className="d-flex flex-column gap-3 w-100 mt-3">
            {partidos.map((partido) => (
                <div key={partido.id} className="card bg-secondary bg-opacity-10 border-secondary text-white shadow-sm animate-fadeIn">
                    ...
                    <div className="card-footer bg-transparent border-top-0 pt-0 pb-3 px-3">
                        <button onClick={() => guardarPronostico(partido.id)} className="btn btn-sm btn-outline-success w-100 fw-bold text-uppercase">
                            💾 Fijar Pronóstico
                        </button>
                    </div>
                </div>
